...
- **真跑深拆稿默认走摘录稿出图**（2026-09-03 再验证）：022 真跑稿直出 21 张、027 复核稿 19 张，均超 18 上限 → `card-ms/variant-calling/<卡片目录名>.md` 摘录稿压到 3 页/主题（12 张/组）后合规；023 深拆直出 16 张属边界可发。真跑稿内容变长后直出必超，别再试直出。

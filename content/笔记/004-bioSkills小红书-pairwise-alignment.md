<!--
META
标题: bioSkills 真实试用 pairwise-alignment：默认 gap=0 会产出多少假 gap？
...
**我拿真实数据测了**：人血红蛋白 α 链 vs β 链（NCBI P69905 / P68871），严格按 skill 原方案复现。

---

## 坑一：默认 gap=0 会塞一堆假 gap
